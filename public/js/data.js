...
var total2019 = parseInt(document.getElementById("2019total").innerHTML.trim());
...
var bike2019 = parseInt(document.getElementById("2019bikes").innerHTML.trim());
  ...
  datasets: [
    {
      ...
      data: [total2012, total2013, total2014, total2015, total2016, total2017, total2018, total2019]
    },
    {
      ...
      data: [bike2012, bike2013, bike2014, bike2015, bike2016, bike2017, bike2018, bike2019]
    }
  ]
};
